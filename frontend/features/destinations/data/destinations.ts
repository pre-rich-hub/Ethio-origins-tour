...
const destinationSeeds: DestinationSeed[] = [
  {
    ...
    relatedTourSlugs: [
      '3-days-addis-ababa-cultural-city-break',
  ...
  { name: 'Gondar', slug: 'gondar', category: 'historical-religious', categoryLabel: 'Historical and Religious Destinations', region: 'Amhara Highlands', image: '/images/dest-gondar.png', imageAlt: 'Gondar heritage route in northern Ethiopia', relatedTourSlugs: ['20-day-ethiopia-historical-cultural-adventure', '6-day-ethiopia-holiday-package'], primaryKeyword: 'Gondar Historical Tours' },
  { name: 'Aksum', slug: 'aksum', category: 'historical-religious', categoryLabel: 'Historical and Religious Destinations', region: 'Tigray', relatedTourSlugs: ['20-day-ethiopia-historical-cultural-adventure'], primaryKeyword: 'Aksum Tours Ethiopia' },
  { name: 'Harar', slug: 'harar', category: 'historical-religious', categoryLabel: 'Historical and Religious Destinations', region: 'Eastern Ethiopia', relatedTourSlugs: ['20-day-ethiopia-historical-cultural-adventure'] },
  ...
  { name: 'Lake Tana', slug: 'lake-tana', category: 'lakes-scenic', categoryLabel: 'Lakes, Waterfalls, and Scenic Destinations', region: 'Bahir Dar', relatedTourSlugs: ['20-day-ethiopia-historical-cultural-adventure', '6-day-ethiopia-holiday-package'] },
  { name: 'Blue Nile Falls', slug: 'blue-nile-falls', category: 'lakes-scenic', categoryLabel: 'Lakes, Waterfalls, and Scenic Destinations', region: 'Bahir Dar', primaryKeyword: 'Blue Nile Falls Tours', relatedTourSlugs: ['20-day-ethiopia-historical-cultural-adventure', '6-day-ethiopia-holiday-package'] },
  { name: 'Lake Langano', slug: 'lake-langano', category: 'lakes-scenic', categoryLabel: 'Lakes, Waterfalls, and Scenic Destinations', region: 'Great Rift Valley', image: '/images/exp-rift.png', imageAlt: 'Rift Valley lake landscape in Ethiopia', relatedTourSlugs: ['4-days-rift-valley-lakes-retreat'] },
  {
  ...
  { name: 'Lake Chamo', slug: 'lake-chamo', category: 'lakes-scenic', categoryLabel: 'Lakes, Waterfalls, and Scenic Destinations', region: 'Arba Minch', image: '/images/client/custom/arbaminch.jpg', imageAlt: 'Lake Chamo route near Arba Minch', relatedTourSlugs: ['13-days-southern-ethiopia-cultural-nature-adventure'] },
  { name: 'Lake Ziway', slug: 'lake-ziway', category: 'lakes-scenic', categoryLabel: 'Lakes, Waterfalls, and Scenic Destinations', region: 'Great Rift Valley', image: '/images/exp-rift.png', imageAlt: 'Lake Ziway and Rift Valley route in Ethiopia', relatedTourSlugs: ['4-days-rift-valley-lakes-retreat'] },
  ...
  { name: 'Simien Mountains National Park', slug: 'simien-mountains-national-park', category: 'mountains-wildlife', categoryLabel: 'Mountains, Parks, and Wildlife', region: 'Northern Ethiopia', image: '/images/exp-simien.png', imageAlt: 'Simien Mountains trekking landscape in Ethiopia', relatedTourSlugs: ['20-day-ethiopia-historical-cultural-adventure'], primaryKeyword: 'Simien Mountains Tours' },
  {
  ...
  },
  {
    ...
    relatedTourSlugs: [
      '5-days-awash-wildlife-and-hot-springs',
      '20-day-ethiopia-historical-cultural-adventure',
    ],
  ...
  { name: 'Mago National Park', slug: 'mago-national-park', category: 'mountains-wildlife', categoryLabel: 'Mountains, Parks, and Wildlife', region: 'Omo Valley', image: '/images/exp-omo.png', imageAlt: 'Omo Valley route near Mago National Park', relatedTourSlugs: ['13-days-southern-ethiopia-cultural-nature-adventure'] },
  ...
  { name: 'Jinka', slug: 'jinka', category: 'tribal-cultural', categoryLabel: 'Tribal and Cultural Destinations', region: 'Omo Valley', image: '/images/exp-omo.png', imageAlt: 'Omo Valley route through Jinka', relatedTourSlugs: ['13-days-southern-ethiopia-cultural-nature-adventure', '10-days-omo-valley-photography-expedition'] },
  { name: 'Turmi', slug: 'turmi', category: 'tribal-cultural', categoryLabel: 'Tribal and Cultural Destinations', region: 'Omo Valley', image: '/images/exp-omo.png', imageAlt: 'Omo Valley route through Turmi', relatedTourSlugs: ['13-days-southern-ethiopia-cultural-nature-adventure', '10-days-omo-valley-photography-expedition'] },
  { name: 'Arba Minch', slug: 'arba-minch', category: 'tribal-cultural', categoryLabel: 'Tribal and Cultural Destinations', region: 'Southern Ethiopia', image: '/images/client/custom/arbaminch.jpg', imageAlt: 'Arba Minch route in southern Ethiopia', relatedTourSlugs: ['13-days-southern-ethiopia-cultural-nature-adventure'] },
  { name: 'Dorze', slug: 'dorze', category: 'tribal-cultural', categoryLabel: 'Tribal and Cultural Destinations', region: 'Southern Ethiopia', image: '/images/client/custom/dorze-village.jpg', imageAlt: 'Dorze cultural village route in southern Ethiopia', relatedTourSlugs: ['13-days-southern-ethiopia-cultural-nature-adventure'] },
  { name: 'Konso', slug: 'konso', category: 'tribal-cultural', categoryLabel: 'Tribal and Cultural Destinations', region: 'Southern Ethiopia', image: '/images/exp-omo.png', imageAlt: 'Southern Ethiopia cultural route through Konso' },
  ...
  { name: 'Bahir Dar', slug: 'bahir-dar', category: 'tribal-cultural', categoryLabel: 'Tribal and Cultural Destinations', region: 'Amhara Region', relatedTourSlugs: ['20-day-ethiopia-historical-cultural-adventure', '6-day-ethiopia-holiday-package'] },
  { name: 'Mekele', slug: 'mekele', category: 'tribal-cultural', categoryLabel: 'Tribal and Cultural Destinations', region: 'Tigray', relatedTourSlugs: ['4-day-danakil-depression-erta-ale-tour', '20-day-ethiopia-historical-cultural-adventure'] },
