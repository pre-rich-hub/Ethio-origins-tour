...
const destinationSeeds: DestinationSeed[] = [
  {
    ...
    relatedTourSlugs: ['3-days-addis-ababa-cultural-city-break', '3-day-lalibela-genna-festival-tour'],
  ...
  { name: 'Gondar', slug: 'gondar', category: 'historical-religious', categoryLabel: 'Historical and Religious Destinations', region: 'Amhara Highlands', image: '/images/dest-gondar.png', imageAlt: 'Gondar heritage route in northern Ethiopia', relatedTourSlugs: ['12-day-historic-north-omo-valley-tour'], primaryKeyword: 'Gondar Historical Tours' },
  { name: 'Aksum', slug: 'aksum', category: 'historical-religious', categoryLabel: 'Historical and Religious Destinations', region: 'Tigray', relatedTourSlugs: [], primaryKeyword: 'Aksum Tours Ethiopia' },
  ...
  { name: 'Fasil Ghebbi', slug: 'fasil-ghebbi', category: 'historical-religious', categoryLabel: 'Historical and Religious Destinations', region: 'Gondar', image: '/images/dest-gondar.png', imageAlt: 'Fasil Ghebbi and Gondar heritage route in Ethiopia', relatedTourSlugs: ['12-day-historic-north-omo-valley-tour'] },
  ...
  { name: 'Lake Tana', slug: 'lake-tana', category: 'lakes-scenic', categoryLabel: 'Lakes, Waterfalls, and Scenic Destinations', region: 'Bahir Dar', relatedTourSlugs: ['12-day-historic-north-omo-valley-tour'] },
  ...
  { name: 'Erta Ale', slug: 'erta-ale', category: 'adventure-geological', categoryLabel: 'Adventure and Geological Wonders', region: 'Afar Region', image: '/images/exp-danakil.png', imageAlt: 'Danakil Depression route for Erta Ale', relatedTourSlugs: ['4-day-danakil-depression-erta-ale-tour'] },
  { name: 'Dallol', slug: 'dallol', category: 'adventure-geological', categoryLabel: 'Adventure and Geological Wonders', region: 'Afar Region', image: '/images/exp-danakil.png', imageAlt: 'Danakil Depression route for Dallol', relatedTourSlugs: ['4-day-danakil-depression-erta-ale-tour'] },
  ...
  { name: 'Bahir Dar', slug: 'bahir-dar', category: 'tribal-cultural', categoryLabel: 'Tribal and Cultural Destinations', region: 'Amhara Region', relatedTourSlugs: ['12-day-historic-north-omo-valley-tour'] },
  { name: 'Mekele', slug: 'mekele', category: 'tribal-cultural', categoryLabel: 'Tribal and Cultural Destinations', region: 'Tigray', relatedTourSlugs: ['4-day-danakil-depression-erta-ale-tour'] },
]
