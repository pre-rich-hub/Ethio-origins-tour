...
const destinationSeeds: DestinationSeed[] = [
  {
    ...
    relatedTourSlugs: ['3-days-addis-ababa-cultural-city-break'],
  ...
  },
  {
    ...
    relatedTourSlugs: [
      '8-days-historic-northern-route',
  ...
  { name: 'Gondar', slug: 'gondar', category: 'historical-religious', categoryLabel: 'Historical and Religious Destinations', region: 'Amhara Highlands', image: '/images/dest-gondar.png', imageAlt: 'Gondar heritage route in northern Ethiopia', relatedTourSlugs: ['8-days-historic-northern-route', '12-day-historic-north-omo-valley-tour'], primaryKeyword: 'Gondar Historical Tours' },
  { name: 'Aksum', slug: 'aksum', category: 'historical-religious', categoryLabel: 'Historical and Religious Destinations', region: 'Tigray', relatedTourSlugs: ['8-days-historic-northern-route'], primaryKeyword: 'Aksum Tours Ethiopia' },
  { name: 'Harar', slug: 'harar', category: 'historical-religious', categoryLabel: 'Historical and Religious Destinations', region: 'Eastern Ethiopia' },
  { name: 'Tiya', slug: 'tiya', category: 'historical-religious', categoryLabel: 'Historical and Religious Destinations', region: 'Central Ethiopia' },
  { name: 'Konso Cultural Landscape', slug: 'konso-cultural-landscape', category: 'historical-religious', categoryLabel: 'Historical and Religious Destinations', region: 'Southern Ethiopia', relatedTourSlugs: ['12-day-historic-north-omo-valley-tour'] },
  { name: 'Yeha Temple', slug: 'yeha-temple', category: 'historical-religious', categoryLabel: 'Historical and Religious Destinations', region: 'Tigray' },
  ...
  { name: 'Fasil Ghebbi', slug: 'fasil-ghebbi', category: 'historical-religious', categoryLabel: 'Historical and Religious Destinations', region: 'Gondar', image: '/images/dest-gondar.png', imageAlt: 'Fasil Ghebbi and Gondar heritage route in Ethiopia', relatedTourSlugs: ['8-days-historic-northern-route', '12-day-historic-north-omo-valley-tour'] },
  { name: 'Holy Trinity Cathedral', slug: 'holy-trinity-cathedral', category: 'historical-religious', categoryLabel: 'Historical and Religious Destinations', region: 'Addis Ababa', image: '/images/gallery-market.png', imageAlt: 'Addis Ababa city culture near Holy Trinity Cathedral', relatedTourSlugs: ['3-days-addis-ababa-cultural-city-break'] },
  { name: 'National Museum of Ethiopia', slug: 'national-museum-of-ethiopia', category: 'historical-religious', categoryLabel: 'Historical and Religious Destinations', region: 'Addis Ababa', image: '/images/gallery-market.png', imageAlt: 'Addis Ababa city culture near the National Museum of Ethiopia', relatedTourSlugs: ['3-days-addis-ababa-cultural-city-break'] },
  { name: 'St. George Church', slug: 'st-george-church', category: 'historical-religious', categoryLabel: 'Historical and Religious Destinations', region: 'Lalibela', image: '/images/dest-gondar.png', imageAlt: 'Lalibela heritage route including St. George Church', relatedTourSlugs: ['8-days-historic-northern-route'] },
  { name: 'Medhane Alem Church', slug: 'medhane-alem-church', category: 'historical-religious', categoryLabel: 'Historical and Religious Destinations', region: 'Lalibela', image: '/images/dest-gondar.png', imageAlt: 'Lalibela heritage route including Medhane Alem Church', relatedTourSlugs: ['8-days-historic-northern-route'] },
  { name: 'Lake Tana', slug: 'lake-tana', category: 'lakes-scenic', categoryLabel: 'Lakes, Waterfalls, and Scenic Destinations', region: 'Bahir Dar', relatedTourSlugs: ['8-days-historic-northern-route', '12-day-historic-north-omo-valley-tour'] },
  { name: 'Blue Nile Falls', slug: 'blue-nile-falls', category: 'lakes-scenic', categoryLabel: 'Lakes, Waterfalls, and Scenic Destinations', region: 'Bahir Dar', primaryKeyword: 'Blue Nile Falls Tours', relatedTourSlugs: ['12-day-historic-north-omo-valley-tour'] },
  { name: 'Lake Langano', slug: 'lake-langano', category: 'lakes-scenic', categoryLabel: 'Lakes, Waterfalls, and Scenic Destinations', region: 'Great Rift Valley', image: '/images/exp-rift.png', imageAlt: 'Rift Valley lake landscape in Ethiopia', relatedTourSlugs: ['4-days-rift-valley-lakes-retreat', '12-day-historic-north-omo-valley-tour'] },
  {
  ...
  { name: 'Lake Abaya', slug: 'lake-abaya', category: 'lakes-scenic', categoryLabel: 'Lakes, Waterfalls, and Scenic Destinations', region: 'Southern Ethiopia', image: '/images/client/custom/arbaminch.jpg', imageAlt: 'Arba Minch and southern Ethiopia lake route', relatedTourSlugs: ['13-days-southern-ethiopia-cultural-nature-adventure'] },
  { name: 'Lake Chamo', slug: 'lake-chamo', category: 'lakes-scenic', categoryLabel: 'Lakes, Waterfalls, and Scenic Destinations', region: 'Arba Minch', image: '/images/client/custom/arbaminch.jpg', imageAlt: 'Lake Chamo route near Arba Minch', relatedTourSlugs: ['13-days-southern-ethiopia-cultural-nature-adventure', '12-day-historic-north-omo-valley-tour'] },
  { name: 'Lake Ziway', slug: 'lake-ziway', category: 'lakes-scenic', categoryLabel: 'Lakes, Waterfalls, and Scenic Destinations', region: 'Great Rift Valley', image: '/images/exp-rift.png', imageAlt: 'Lake Ziway and Rift Valley route in Ethiopia', relatedTourSlugs: ['4-days-rift-valley-lakes-retreat', '12-day-historic-north-omo-valley-tour'] },
  { name: 'Lake Hawassa', slug: 'lake-hawassa', category: 'lakes-scenic', categoryLabel: 'Lakes, Waterfalls, and Scenic Destinations', region: 'Hawassa', image: '/images/client/custom/hawassa.jpg', imageAlt: 'Lake Hawassa and southern Ethiopia route', relatedTourSlugs: ['4-days-rift-valley-lakes-retreat'] },
  ...
  { name: 'Simien Mountains National Park', slug: 'simien-mountains-national-park', category: 'mountains-wildlife', categoryLabel: 'Mountains, Parks, and Wildlife', region: 'Northern Ethiopia', image: '/images/exp-simien.png', imageAlt: 'Simien Mountains trekking landscape in Ethiopia', relatedTourSlugs: ['6-days-simien-mountains-trekking', '12-day-historic-north-omo-valley-tour'], primaryKeyword: 'Simien Mountains Tours' },
  {
    ...
    relatedTourSlugs: ['7-days-bale-mountains-wildlife-safari'],
  ...
  },
  {
    ...
    relatedTourSlugs: ['5-days-awash-wildlife-and-hot-springs'],
  ...
  { name: 'Nech Sar National Park', slug: 'nech-sar-national-park', category: 'mountains-wildlife', categoryLabel: 'Mountains, Parks, and Wildlife', region: 'Arba Minch', image: '/images/client/custom/arbaminch.jpg', imageAlt: 'Arba Minch route near Nech Sar National Park', relatedTourSlugs: ['13-days-southern-ethiopia-cultural-nature-adventure'] },
  { name: 'Mago National Park', slug: 'mago-national-park', category: 'mountains-wildlife', categoryLabel: 'Mountains, Parks, and Wildlife', region: 'Omo Valley', image: '/images/exp-omo.png', imageAlt: 'Omo Valley route near Mago National Park', relatedTourSlugs: ['13-days-southern-ethiopia-cultural-nature-adventure', '12-day-historic-north-omo-valley-tour'] },
  ...
  { name: 'Ras Dashen', slug: 'ras-dashen', category: 'mountains-wildlife', categoryLabel: 'Mountains, Parks, and Wildlife', region: 'Simien Mountains', image: '/images/exp-simien.png', imageAlt: 'Simien Mountains trekking landscape near Ras Dashen', relatedTourSlugs: ['6-days-simien-mountains-trekking'] },
  { name: 'Mount Chilalo', slug: 'mount-chilalo', category: 'mountains-wildlife', categoryLabel: 'Mountains, Parks, and Wildlife', region: 'Oromia Highlands' },
  {
    ...
    relatedTourSlugs: ['5-days-danakil-depression-expedition'],
  ...
  { name: 'Erta Ale', slug: 'erta-ale', category: 'adventure-geological', categoryLabel: 'Adventure and Geological Wonders', region: 'Afar Region', image: '/images/exp-danakil.png', imageAlt: 'Danakil Depression route for Erta Ale', relatedTourSlugs: ['5-days-danakil-depression-expedition'] },
  { name: 'Dallol', slug: 'dallol', category: 'adventure-geological', categoryLabel: 'Adventure and Geological Wonders', region: 'Afar Region', image: '/images/exp-danakil.png', imageAlt: 'Danakil Depression route for Dallol', relatedTourSlugs: ['5-days-danakil-depression-expedition'] },
  ...
  { name: 'Babille Elephant Sanctuary', slug: 'babille-elephant-sanctuary', category: 'adventure-geological', categoryLabel: 'Adventure and Geological Wonders', region: 'Eastern Ethiopia' },
  {
    ...
    relatedTourSlugs: [
      '13-days-southern-ethiopia-cultural-nature-adventure',
      '10-days-omo-valley-photography-expedition',
      '12-day-historic-north-omo-valley-tour',
    ],
  ...
  { name: 'Jinka', slug: 'jinka', category: 'tribal-cultural', categoryLabel: 'Tribal and Cultural Destinations', region: 'Omo Valley', image: '/images/exp-omo.png', imageAlt: 'Omo Valley route through Jinka', relatedTourSlugs: ['13-days-southern-ethiopia-cultural-nature-adventure', '10-days-omo-valley-photography-expedition', '12-day-historic-north-omo-valley-tour'] },
  { name: 'Turmi', slug: 'turmi', category: 'tribal-cultural', categoryLabel: 'Tribal and Cultural Destinations', region: 'Omo Valley', image: '/images/exp-omo.png', imageAlt: 'Omo Valley route through Turmi', relatedTourSlugs: ['13-days-southern-ethiopia-cultural-nature-adventure', '10-days-omo-valley-photography-expedition', '12-day-historic-north-omo-valley-tour'] },
  { name: 'Arba Minch', slug: 'arba-minch', category: 'tribal-cultural', categoryLabel: 'Tribal and Cultural Destinations', region: 'Southern Ethiopia', image: '/images/client/custom/arbaminch.jpg', imageAlt: 'Arba Minch route in southern Ethiopia', relatedTourSlugs: ['13-days-southern-ethiopia-cultural-nature-adventure', '12-day-historic-north-omo-valley-tour'] },
  { name: 'Dorze', slug: 'dorze', category: 'tribal-cultural', categoryLabel: 'Tribal and Cultural Destinations', region: 'Southern Ethiopia', image: '/images/client/custom/dorze-village.jpg', imageAlt: 'Dorze cultural village route in southern Ethiopia', relatedTourSlugs: ['13-days-southern-ethiopia-cultural-nature-adventure', '12-day-historic-north-omo-valley-tour'] },
  { name: 'Konso', slug: 'konso', category: 'tribal-cultural', categoryLabel: 'Tribal and Cultural Destinations', region: 'Southern Ethiopia', image: '/images/exp-omo.png', imageAlt: 'Southern Ethiopia cultural route through Konso', relatedTourSlugs: ['12-day-historic-north-omo-valley-tour'] },
  { name: 'Chencha', slug: 'chencha', category: 'tribal-cultural', categoryLabel: 'Tribal and Cultural Destinations', region: 'Southern Ethiopia', image: '/images/client/custom/dorze-village.jpg', imageAlt: 'Southern Ethiopia route through Chencha and Dorze', relatedTourSlugs: ['12-day-historic-north-omo-valley-tour'] },
  { name: 'Debark', slug: 'debark', category: 'tribal-cultural', categoryLabel: 'Tribal and Cultural Destinations', region: 'Northern Ethiopia', image: '/images/exp-simien.png', imageAlt: 'Simien Mountains route near Debark', relatedTourSlugs: ['6-days-simien-mountains-trekking'] },
  { name: 'Bahir Dar', slug: 'bahir-dar', category: 'tribal-cultural', categoryLabel: 'Tribal and Cultural Destinations', region: 'Amhara Region', relatedTourSlugs: ['8-days-historic-northern-route', '12-day-historic-north-omo-valley-tour'] },
  { name: 'Mekele', slug: 'mekele', category: 'tribal-cultural', categoryLabel: 'Tribal and Cultural Destinations', region: 'Tigray', relatedTourSlugs: ['5-days-danakil-depression-expedition'] },
]
