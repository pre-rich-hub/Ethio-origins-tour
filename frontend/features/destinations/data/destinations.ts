...
const destinationSeeds: DestinationSeed[] = [
  ...
  { name: 'Holy Trinity Cathedral', slug: 'holy-trinity-cathedral', category: 'historical-religious', categoryLabel: 'Historical and Religious Destinations', region: 'Addis Ababa', image: '/images/gallery-market.png', imageAlt: 'Addis Ababa city culture near Holy Trinity Cathedral' },
  { name: 'National Museum of Ethiopia', slug: 'national-museum-of-ethiopia', category: 'historical-religious', categoryLabel: 'Historical and Religious Destinations', region: 'Addis Ababa', image: '/images/gallery-market.png', imageAlt: 'Addis Ababa city culture near the National Museum of Ethiopia' },
