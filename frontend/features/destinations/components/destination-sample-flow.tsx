          ...
          {localizedDestination.itinerary.map((item, index) => (
            ...
            >
              ...
              <p className="mt-4 font-sans text-sm font-light leading-relaxed text-muted-foreground">
                {t.destinationsPage.sampleCardText}
              </p>
            </article>
          ))}
        </div>
