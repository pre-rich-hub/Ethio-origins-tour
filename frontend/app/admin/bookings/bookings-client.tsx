    ...
    <div className="p-8">
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Manage tour bookings and inquiries
          </p>
        </div>
      </div>
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-xl border border-border p-12 shadow-xs text-center">
          <CalendarIcon size={40} className="mx-auto text-muted-foreground/40 mb-3" />
          <p className="text-muted-foreground">No bookings found</p>
          <p className="text-xs text-muted-foreground/60 mt-1">
            {search ? 'Try a different search term' : 'Bookings will appear here when customers submit them'}
          </p>
        </div>
      ) : (
